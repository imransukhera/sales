...
export class TaskComponent implements OnInit {
  ...
  item = [
    ...
    { project: 'Desklancer', task: 'checking time', date: 'Thu 21, 2024', status: 'Complete', description: 'aksdhkajskjalksjdlajdlkajkldjaljdlajklajlkdjslakjdljaljsdkaljsdlk' },
